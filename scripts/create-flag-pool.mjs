...
const QZSOL_MINT = '5xNuRxxiGjf4FzpCqLgC65V4FTBeMxFZYerGpydhKboj';
const QZSOL_DECIMALS = 9;
const SOL_DECIMALS = 9;

// Liquidity amounts
const QZSOL_AMOUNT = 1;    // 1 FLAG token
const SOL_AMOUNT = 0.005;          // 0.005 SOL (leaving enough for pool fees and rent)
